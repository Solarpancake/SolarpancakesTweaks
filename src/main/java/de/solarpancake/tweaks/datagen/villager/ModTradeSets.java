...
public class ModTradeSets {
    public static final ResourceKey<TradeSet> BARTENDER_LEVEL_1 = create("bartender/level_1");
    public static final ResourceKey<TradeSet> BARTENDER_LEVEL_2 = create("bartender/level_2");

    public static void bootstrap(BootstrapContext<TradeSet> context) {
        register(context, BARTENDER_LEVEL_1, ModTags.Trades.BARTENDER_LEVEL_1);
        register(context, BARTENDER_LEVEL_2, ModTags.Trades.BARTENDER_LEVEL_2);
    }

    private static ResourceKey<TradeSet> create(final String id) {
        return ResourceKey.create(Registries.TRADE_SET, Identifier.fromNamespaceAndPath(Solarpancakestweaks.MODID, id));
    }
