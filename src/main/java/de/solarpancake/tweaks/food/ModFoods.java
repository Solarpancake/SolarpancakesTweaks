...
public class ModFoods {
    ...
    public static final Consumable GREEN_APPLE_CAN_CONSUMABLE = Consumables.defaultDrink()
            .consumeSeconds(1.6f)
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(ModEffects.DRUNK_EFFECT, 400)))
            .build();

    public static final Consumable LEMON_CONSUMABLE = Consumables.defaultFood()
            .consumeSeconds(1.2f)
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.LUCK, 400)))
            .build();
